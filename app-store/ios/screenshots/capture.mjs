...
// Viewport CSS-pixel sizes and scale factors that produce exact App Store pixel dims.
const DEVICES = [
  { name: 'iphone-6.7', width: 430, height: 932, scale: 3 }, // 1290 x 2796 px
  { name: 'iphone-6.5', width: 414, height: 896, scale: 3 }, // 1242 x 2688 px
  { name: 'ipad-13', width: 1032, height: 1376, scale: 2 }, // 2064 x 2752 px
  { name: 'ipad-12.9', width: 1024, height: 1366, scale: 2 }, // 2048 x 2732 px
];
